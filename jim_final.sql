...
--
-- Host: localhost:3306
-- Generation Time: Sep 22, 2021 at 09:21 PM
...
INSERT INTO `auditorium` (`id`, `title`, `content`, `created_at`, `updated_at`) VALUES
(1, 'TEST1', '<p>dfsf</p>', '2021-09-17 08:22:14', '2021-09-17 08:22:14');

-- --------------------------------------------------------

--
-- Table structure for table `auditorium_images`
--

CREATE TABLE `auditorium_images` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `auditorium_images`
--

INSERT INTO `auditorium_images` (`id`, `auditorium_id`, `images`, `created_at`, `updated_at`) VALUES
(1, 1, '/images/auditorium/auditorium_01631866934.png', '2021-09-17 08:22:14', '2021-09-17 08:22:14');
...
--
-- Table structure for table `board_room_images`
--

CREATE TABLE `board_room_images` (
  `id` int(11) NOT NULL,
...
INSERT INTO `computer_lab` (`id`, `title`, `content`, `created_at`, `updated_at`) VALUES
(1, 'TEST', '<p>COMPUTERLAB</p>', '2021-09-17 07:55:14', '2021-09-17 07:56:52');

-- --------------------------------------------------------

--
-- Table structure for table `computer_lab_images`
--

CREATE TABLE `computer_lab_images` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `computer_lab_images`
--

INSERT INTO `computer_lab_images` (`id`, `lab_id`, `images`, `created_at`, `updated_at`) VALUES
(2, 1, '/images/lab/lab_01631865412.png', '2021-09-17 07:56:52', '2021-09-17 07:56:52'),
(3, 1, '/images/lab/lab_11631865412.png', '2021-09-17 07:56:52', '2021-09-17 07:56:52');
...
--
-- Table structure for table `directors_images`
--

CREATE TABLE `directors_images` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `directors_message`
--

CREATE TABLE `directors_message` (
  `id` int(11) NOT NULL,
  `title` varchar(255) NOT NULL,
  `content` text NOT NULL,
  `created_at` datetime NOT NULL,
...
INSERT INTO `events` (`id`, `title`, `description`, `event_date`, `image`, `status`, `created_at`, `updated_at`) VALUES
(1, 'sample', 'TEST', '2021-09-16', '/images/events/events_1631807342.png', 1, '2021-09-16 15:49:02', '2021-09-16 15:49:02');
...
--
-- Dumping data for table `guest_speaker`
--

INSERT INTO `guest_speaker` (`id`, `resource_person`, `activity`, `date`, `beneficiaries`, `time`, `place`, `content`, `created_at`, `updated_at`) VALUES
(2, 'Divakar', 'TEST', '2021-09-17', 'gfd', '22:35', 'trichy', '<p>gfd</p>', '2021-09-17 16:00:43', '2021-09-17 16:05:24');
...
INSERT INTO `hostel` (`id`, `title`, `content`, `created_at`, `updated_at`) VALUES
(1, 'sample', '<p>dwsa</p>', '2021-09-17 10:38:30', '2021-09-17 10:38:30');
...
--
-- Dumping data for table `hostel_accom`
--

INSERT INTO `hostel_accom` (`id`, `title`, `attachment`, `content`, `status`, `created_at`, `updated_at`) VALUES
(1, 'sample', '/images/course_allotment/infocus_1630130569.png', '<p>TEST1</p>', 1, '2021-08-28 05:32:21', '2021-08-28 06:02:49');
...
INSERT INTO `hostel_images` (`id`, `hostel_id`, `images`, `created_at`, `updated_at`) VALUES
(1, 1, '/images/hostel/hostel_01631875110.png', '2021-09-17 10:38:30', '2021-09-17 10:38:30');
...
--
-- Table structure for table `recruiters_images`
--

CREATE TABLE `recruiters_images` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `research_room_images`
--

CREATE TABLE `research_room_images` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `student_affinities`
--

CREATE TABLE `student_affinities` (
  `id` int(11) NOT NULL,
  `title` varchar(255) NOT NULL,
  `content` text NOT NULL,
  `created_at` datetime NOT NULL,
...
--
-- Table structure for table `student_affinities_images`
--

CREATE TABLE `student_affinities_images` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `wifi_images`
--

CREATE TABLE `wifi_images` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `auditorium_images`
--
ALTER TABLE `auditorium_images`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `board_room_images`
--
ALTER TABLE `board_room_images`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `computer_lab_images`
--
ALTER TABLE `computer_lab_images`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `directors_images`
--
ALTER TABLE `directors_images`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `directors_message`
--
ALTER TABLE `directors_message`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `guest_speaker`
--
...
--
-- Indexes for table `recruiters_images`
--
ALTER TABLE `recruiters_images`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `research_room`
--
ALTER TABLE `research_room`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `research_room_images`
--
ALTER TABLE `research_room_images`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `student_affinities`
--
ALTER TABLE `student_affinities`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `student_affinities_images`
--
ALTER TABLE `student_affinities_images`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `wifi_images`
--
ALTER TABLE `wifi_images`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `auditorium_images`
--
ALTER TABLE `auditorium_images`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
ALTER TABLE `board_room`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `board_room_images`
--
ALTER TABLE `board_room_images`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `computer_lab`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `computer_lab_images`
--
ALTER TABLE `computer_lab_images`
...
ALTER TABLE `department`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `directors_images`
--
ALTER TABLE `directors_images`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `directors_message`
--
ALTER TABLE `directors_message`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `fee`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `guest_speaker`
--
ALTER TABLE `guest_speaker`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
ALTER TABLE `recruiters`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `recruiters_images`
--
ALTER TABLE `recruiters_images`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `research_room`
--
ALTER TABLE `research_room`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `research_room_images`
--
ALTER TABLE `research_room_images`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `state`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `student_affinities`
--
ALTER TABLE `student_affinities`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `student_affinities_images`
--
ALTER TABLE `student_affinities_images`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `wifi`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `wifi_images`
--
ALTER TABLE `wifi_images`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
