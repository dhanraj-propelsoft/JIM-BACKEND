        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('home-page.store_events') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="col-md-6">
                                <input id="date" type="date" class="form-control" name="event_date" value="{{ old('event_date') }}" required autofocus>
